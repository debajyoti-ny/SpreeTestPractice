 ...
 */
public class BaseSteps_Hybrid {

    public static final int DEFAULT_WAIT_TIME = 10;

    protected WebDriver driver = DriverFactory.getInstance("chrome").getDriver();
    //protected WebDriver driver = DriverFactory.getInstance("grid_chrome_32").getDriver(); //To run on the grid
    ...
    public void delay(int timeInMili){
        try {
