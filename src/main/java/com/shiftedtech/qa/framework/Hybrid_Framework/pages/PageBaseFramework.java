...
public class PageBaseFramework {
    protected WebDriver driver;
    public static final int DEFAULT_WAIT_TIME = 5;

    public PageBaseFramework(){
        this.driver = DriverFactory.getInstance("chrome").getDriver(); //Used for Method Parallel
    }

    public PageBaseFramework(WebDriver driver){
        this.driver = driver;
    }
