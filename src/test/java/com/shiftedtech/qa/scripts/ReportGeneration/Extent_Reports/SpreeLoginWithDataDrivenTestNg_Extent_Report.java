...
public class SpreeLoginWithDataDrivenTestNg_Extent_Report extends ScriptBaseTestNG_Extent_Report {
    ...
    public static Object[][] loginDataProviderAsArray(){
        Object[][] data = {
                                ...
                                ,{"hema0ahmad@gmail.comxxxx", "hema123"} //Want it to fail intentionally to see the SS in report
                          };
        return data;
    }
