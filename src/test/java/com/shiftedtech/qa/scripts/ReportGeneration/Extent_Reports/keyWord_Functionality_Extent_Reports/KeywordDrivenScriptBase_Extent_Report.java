...
public class KeywordDrivenScriptBase_Extent_Report extends ScriptBaseCompositePOI_TestNG_ExtentReport{
...
//            reporter.logInfo(ts.getStep() + " - " + ts.getKeyword(), ts.toString()); //It's used when generating the Paxo reports
